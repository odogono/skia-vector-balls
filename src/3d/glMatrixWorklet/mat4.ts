 ...
 * @return {vec3} out
 */
export const getTranslation = (out: vec3, mat: mat4): vec3 => {
  'worklet';
  out[0] = mat[12];
  out[1] = mat[13];
  out[2] = mat[14];
 ...
 * @returns {mat4} out
 */
export const rotateX = (out: mat4, a: mat4, rad: number): mat4 => {
  'worklet';
 ...
 * @returns {mat4} out
 */
export const rotateY = (out: mat4, a: mat4, rad: number): mat4 => {
  'worklet';
  const s = Math.sin(rad);
  const c = Math.cos(rad);
  const a00 = a[0];
 ...
 * @returns {mat4} out
 */
export const rotateZ = (out: mat4, a: mat4, rad: number): mat4 => {
  'worklet';
  const s = Math.sin(rad);
  const c = Math.cos(rad);
  const a00 = a[0];
 ...
 * @returns {mat4} out
 */
export const fromQuat = (out: mat4, q: quat): mat4 => {
  'worklet';
  const x = q[0],
    y = q[1],
    z = q[2],
 ...
 * @returns {mat4} out
 */
export const fromRotationTranslation = (out: mat4, q: quat, v: vec3): mat4 => {
  'worklet';
  // Quaternion math
  const x = q[0],
    y = q[1],
